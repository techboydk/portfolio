...
const Works = () => {
  ...
  const handleClick = (e) => {
    ...
    e.target.innerText === "NODE JS" && setCategory("nodejs");
  ...
  return (
    <div className="works-section" id="works">
      ...
      <div className="tags">
        <div className="header-btn btn active-tag" onClick={handleClick}>
          <span>All</span>
        </div>
        <div className="header-btn btn" onClick={handleClick}>
          <span>Html & Css</span>
        </div>
        <div className="header-btn btn" onClick={handleClick}>
          <span>React js</span>
